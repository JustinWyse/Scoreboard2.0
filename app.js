...
function createCategoryPieChart() {
  ...
  filteredData.forEach(r => {
    // Use grandparent_category for subcategories, fall back to parent_category if not available
    const category = r['grandparent_category'] || r['parent_category'] || r['greatgrandparent_category'] || 'Unknown';
