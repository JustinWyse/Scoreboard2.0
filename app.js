  ...
  if (kpiContainer) {
    kpiContainer.innerHTML = `
      <div class="kpi ${getTrendClass(total_attendees, 1000)}">
        ...
        <div class="kpi_change">${getChangeArrow(attendees_change, hasDateSelection)} ${getChangeText(attendees_change, hasPreviousData, hasDateSelection)}</div>
      ...
      <div class="kpi ${getTrendClass(total_bookings, 1200)}">
        ...
        <div class="kpi_change">${getChangeArrow(bookings_change, hasDateSelection)} ${getChangeText(bookings_change, hasPreviousData, hasDateSelection)}</div>
      ...
      <div class="kpi ${getTrendClass(avg_attendance, target_avg_attendance)}">
        ...
        <div class="kpi_change">${getChangeArrow(avg_attendance_change, hasDateSelection)} ${getChangeText(avg_attendance_change, hasPreviousData, hasDateSelection)}</div>
      ...
      <div class="kpi trend-neutral">
        ...
        <div class="kpi_change">${getChangeArrow(unique_classes_change, hasDateSelection)} ${getChangeText(unique_classes_change, hasPreviousData, hasDateSelection)}</div>
      ...
      <div class="kpi trend-neutral">
        ...
        <div class="kpi_change">${getChangeArrow(unique_participants_change, hasDateSelection)} ${getChangeText(unique_participants_change, hasPreviousData, hasDateSelection)}</div>
