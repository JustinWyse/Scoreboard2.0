"""
Scoreboard 3.1 Dashboard
✨ New Features:
- Multi-category comparison (up to 3 categories side-by-side)
- Year-over-year visualization in charts (line graphs + pie charts)
- 2-year comparison option
- Verified YoY math (exact same date range)
- Collapsible sections for better organization
- Removed data table (not needed)
- Fixed SOMA data duplicates (deduplication by session_guid)
...
# Page configuration
st.set_page_config(
    page_title="Scoreboard - Version 3.1",
    page_icon="📊",
    layout="wide",
...
def check_access():
    ...
    if not st.session_state.authenticated:
        ...
        st.title("📊 Scoreboard - Version 3.1 Access")
        st.write("Enter access code to view the dashboard:")
        
        # Version info
        st.info(
            "✨ **New in Version 3.1**\n\n"
            "• Multi-category comparison (up to 3 categories)\n"
            "• Year-over-year chart visualization\n"
            "• 2-year comparison option\n"
            "• Verified YoY math (exact date ranges)\n"
            "• Collapsible sections\n"
            "• Removed data table\n"
            "• Fixed SOMA data inflation\n\n"
...
def main():
    ...
    if data:
        ...
        duplicates_removed = len(raw_data) - len(data)
        if duplicates_removed > 0:
            st.sidebar.warning(f"🔧 Removed {duplicates_removed:,} duplicate records")
    ...
    <head>
        ...
        <title>Scoreboard - Version 3.1</title>
