...
# Page configuration
st.set_page_config(
    page_title="Scoreboard - Beta 2.0",
    page_icon="📊",
    layout="wide",
...
def check_access():
    ...
    if not st.session_state.authenticated:
        ...
        st.title("📊 Scoreboard - Beta 2.0 Access")
        st.write("Enter access code to view the dashboard:")
        
        # Beta notice
        st.info(
            "⚠️ **Beta Version Notice**\n\n"
            "This is a test and work in progress version. "
            "Please spot check/verify data in RGP when possible to ensure accuracy. "
            "Notify Chief of Staff of any irregularities or issues."
        )
...
def main():
    ...
    with st.sidebar.expander("📖 How to Use", expanded=False):
        ...
        **Getting Started:**
        ...
        2. Choose filters (instructor, facility, category)
    ...
    <head>
        ...
        <title>Scoreboard - Beta 2.0</title>
